/**
 * Brand Metadata - Core brand identity
 * 
 * This file contains brand name, SEO metadata, and icon configuration.
 * Edit these values to update branding, then run: pnpm generate
 */

/**
 * Icon paths from Lucide GraduationCap icon
 * These are used to generate SVG logos programmatically
 */
...
export const brand = {
    ...
    /** Lucide icon name for dynamic icon rendering */
    iconName: 'GraduationCap',

    /** Icon SVG paths for programmatic rendering */
    iconPaths,

    /** Site metadata for SEO and OpenGraph */
    metadata: {
...
export const iconName = brand.iconName;
export const metadata = brand.metadata;
export const typography = brand.typography;

/**
 * Generate SVG markup for the brand icon
 */
